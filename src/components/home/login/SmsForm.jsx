    ...
    <div className="flex rounded-[10px] flex-col gap-[20px] border p-[30px]">
      <div className="flex gap-[20px] justify-center items-center flex-col">
        ...
        <p className="font-medium text-gray-500">
          Let's start off with your phone number.
        </p>
      </div>
      <PhoneNumberInput />
      <button className="bg-amber-500 mt-[20px] py-[6px] rounded-[20px] text-white font-[590]">
        Continue with SMS
      </button>
      <div className="flex justify-center items-center">
        <p className="font-medium text-gray-500">
          Don't have an account yet?{" "}
          <span className="text-amber-500 text-lg cursor-pointer">SignUp</span>
        </p>
      </div>
      ...
      <button
        className="border px-[15px] py-2 rounded-[20px] border-gray-300"
